...
(i)		Incluir um atributo que trate sobre as metas que estão no operador ESCOLHA. 
	 ...
	 *
	 *      SAVIO: Então deve ter um tempo para que o agente monitor possa verificar se alguma dessas ações foram executadas,
	 *      né? SUGESTÃO: Eu colocaria um atributo para indicar qual a meta que foi escolhida.
	 */
...
(ii) 	Percebi que você implementou a escolha das metas que serão cumpridas ou não utilizando Threads. 
	 ...
	 *
	 *      SAVIO: Isso mesmo! Mas você poderia deixar esse método genérico para que consigamos rodar outros estudos de 
	 *      caso com facilidade, colocando parâmetros de entrada.
	 */
(iii) Comparei o algoritmo com o artigo que enviamos para o CLEI e não foi incluída a entidade Contrato;
         /*     SAVIO: o contrato seria um conjunto de ações, conforme conversamos pelo celular... Temos que ter a aprovação
         *      dos professores.
         */
