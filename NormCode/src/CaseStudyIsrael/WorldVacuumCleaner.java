...
public class WorldVacuumCleaner extends Environment {
	...
	public WorldVacuumCleaner(String name, String host, String port) {
		...
		Room roomA=new Room("roomA", true);
		Room roomB=new Room("roomB", true);
		roomA.setNext(roomB);
		roomB.setNext(roomA);
		Place place=new Place(roomA);
		addObject("Place", place);
		
		
		Organization cleanserOrg=new CleanserOrg("CleanserOrg", this, null);
		addOrganization("CleanserOrg", cleanserOrg);
...
//		vacuumCleaner.setManager(gerente);
		...
		Calendar date1=new GregorianCalendar(2013, GregorianCalendar.JUNE, 29, 15, 8, 20);
		Calendar date2=new GregorianCalendar(2013, GregorianCalendar.JUNE, 29, 15, 9, 40);
		...
		propertyplaceName2.setValue(new Place(new Room("roomA", true)));
		...
		Calendar dat1=new GregorianCalendar(2013, GregorianCalendar.JUNE, 29, 0, 5, 20);
		Calendar dat2=new GregorianCalendar(2013, GregorianCalendar.JUNE, 29, 17, 7, 59);
		...
		Norm N3=new N3("N3", NormType.PERMISSION, vacuumCleaner, cleanserOrg, na, constraints3);
